...
class PDF extends FPDF
{
    ...
    function LoadData($sqlConnection)
    {
        ...
        $data = array();
        $res_rechnungenheiz = mysqli_query($sqlConnection, "SELECT * FROM rechnungen WHERE Typ='Heizkosten' AND YEAR(Datum)='$jahr'");
    ...
    function Header()
    {
        ...
        $this->Ln(5);
        $this->Cell(0,0,'Heizkostenabrechnung',0,0,'C');
        $this->Ln(20);
    }
