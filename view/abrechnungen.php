...
<div class="container">
    <div class="page-header">
		...
		<button type="submit" action="pdfgeneratorheizkosten.php" class="btn btn-primary">Heizkosten Drucken</button>
		<button type="submit" action="pdfgeneratornebenkosten.php" class="btn btn-primary">Nebenkosten Drucken</button>
