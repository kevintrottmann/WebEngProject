...
<div class="container">
    ...
    <div class="table-responsive">
        ...
        <a href="form_neue_einnahme.php" class="btn btn-primary" type="button"> Einnahmen erfassen </a> <a
                href="pdfgeneratoreinnahmen.php" target="_blank" class="btn btn-primary">Drucken</a>
        </br>
        </br>
        </br>
